...
class TTextTheme{
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 16, fontWeight: FontWeight.w400 , color: Colors.white),
...
///Customizable Light Text Theme
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 16, fontWeight: FontWeight.w400 , color: Colors.black),
    ...
    bodyLarge:  const TextStyle().copyWith(fontSize: 19, fontWeight: FontWeight.w500 , color: Colors.black),
    bodyMedium: const TextStyle().copyWith(fontSize: 19, fontWeight: FontWeight.normal , color: Colors.black),
    bodySmall:  const TextStyle().copyWith(fontSize: 19, fontWeight: FontWeight.w500 , color: Colors.black.withOpacity(0.5)),
